...
Bugs:
* Fixed a bug with the interaction between the current time, and configured delay and rounding periods with DetermineGetMetricDataWindow(). Computed start and end times should now consistently agree with the rounding window specified.
